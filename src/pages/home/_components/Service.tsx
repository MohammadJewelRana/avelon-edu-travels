...
const services = [
  {
    ...
    title: "Study Abroad",
    description:
      "Get expert guidance for admissions, scholarships, university selection, and application support to study in top destinations worldwide.",
  },
  {
    icon: FaPassport,
    title: "Student Visa",
...
>
  ...
  <p className="mx-auto mt-8 max-w-2xl text-lg leading-8 text-gray-600">
    ...
    <span className="font-semibold text-[#111111]"> university admissions</span>,
    <span className="font-semibold text-[#111111]"> student & visit visas</span>,
    <span className="font-semibold text-[#111111]"> work permits</span>,
    <span className="font-semibold text-[#111111]"> air ticket booking</span>, to
    <span className="font-semibold text-[#111111]"> customized tour packages</span>.
    Your success and seamless travel experience are our top priorities.
  </p>
</motion.div>
        {/* Cards */}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7 }}
          className="mt-24 rounded-[40px] bg-[#0F2F75] p-10 text-center text-white lg:p-16"
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-slate-300">
            Whether you want to study abroad, apply for a visa,
            or plan your next holiday, our experienced team is
            ready to help you at every step.
          </p>

          <button className="mt-10 rounded-full bg-white px-8 py-4 font-semibold text-[#0F2F75] transition duration-300 hover:-translate-y-1 hover:bg-cyan-500 hover:text-white">
